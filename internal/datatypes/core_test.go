...
var datatypeTests = []struct {
	...
	{1, int64(1), false, EnumFromJSON},
	{"bad data", int64(1), true, EnumFromJSON},
	{0.6, int64(0), false, EnumFromJSON},
	{6, int64(6), false, EnumFromJSON},
	{"test", "test", false, StringFromJSON},
	{5, "test", true, StringFromJSON},
	{"5", "5", false, StringFromJSON},
	{"test", "test", false, TextFromJSON},
	{5, "test", true, TextFromJSON},
	{"5", "5", false, TextFromJSON},
